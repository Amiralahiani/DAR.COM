...
namespace RealEstateAdmin.Migrations.ApplicationDb
{
    ...
    [Migration("20260531001349_AddEquipementsToBien")]
    partial class AddEquipementsToBien
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateAdmin.Models.Annonce", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasChauffageCentral")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);

                    b.Property<bool>("HasClimatisation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("HasPiscine")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);

                    b.Property<bool>("HasTerrasse")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("RealEstateAdmin.Models.AnnoncePhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealEstateAdmin.Models.BienView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealEstateAdmin.Models.AnnoncePhoto", b =>
                {
                    b.HasOne("RealEstateAdmin.Models.Annonce", "Annonce")
                        .WithMany("Photos")
